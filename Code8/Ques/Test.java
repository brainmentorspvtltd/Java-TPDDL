...
public class Test {
	...
	public static void main(String[] args) {
		...
		/*Customer customerRam = customerMap.get("Ram");
		HashMap<String,TreeSet<Address>> ramaddressMap = customerRam.getAddressMap();
		TreeSet<Address> officeSet = ramaddressMap.get("office");*/
